...
PYBIND11_MODULE(faco_tsp, m) {
  ...
  m.def(
      "get_dynamic", []() { return omp_get_dynamic() != 0; },
  ...
  py::class_<PyMFACOTrace>(m, "MFACOTrace")
      ...
      .def("to_trace_list", &PyMFACOTrace::to_trace_list,
           "Convert batch trace to list of dict traces for Python "
           "replay_logp_batch");
  ...
  py::class_<PyMFACO_TSP>(m, "MFACO_TSP")
      ...
      .def("sample", &PyMFACO_TSP::sample, py::arg("invtemp") = 1.0f,
           ...
           "Sample solutions from all ants. Returns (costs, flats, "
           "touched_list, logps_nondiff, traces)")
      .def("_update_pheromone_from_flat",
           &PyMFACO_TSP::update_pheromone_from_flat, py::arg("best_flat"),
           py::arg("best_cost"),
           "Update pheromone: evaporate + deposit on best route")
      .def("load_snapshot", &PyMFACO_TSP::load_snapshot, py::arg("pheromone"),
           py::arg("source_route"), py::arg("source_cost"),
           py::arg("best_route"), py::arg("best_cost"), py::arg("tau_min"),
           py::arg("tau_max"), py::arg("nn_list"), py::arg("backup_list"),
